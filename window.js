...
Window.prototype.draw = function () {
    ...
    // HUD
    this.drawHealthPlayer(10, this.top() - 20, player1);
    this.drawHealthPlayer(this.width - 110, this.top() - 20, player2);
}
Window.prototype.drawHealthPlayer = function (x,y,player) {
...
if (player == player1) {
    if(player.health > 70){
        this.context.fillStyle = '#DE0101';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 70 && player.health > 50){
        this.context.fillStyle = '#BE0000';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 50 && player.health > 30){
        this.context.fillStyle = '#9E0000';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 30 && player.health > 20){
        this.context.fillStyle = '#7E0000';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if (player.health <= 20 && player.health > 10){
        this.context.fillStyle = '#5E0000';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 10 && player.health >= 0){
        this.context.fillStyle = '#3E0000';
        this.context.fillRect(x, y, player.health, 10);
    }
} else {
    if(player.health > 70){
        this.context.fillStyle = '#0255DE';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 70 && player.health > 50){
        this.context.fillStyle = '#0035BE';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 50 && player.health > 30){
        this.context.fillStyle = '#00159E';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 30 && player.health > 20){
        this.context.fillStyle = '#00007E';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if (player.health <= 20 && player.health > 10){
        this.context.fillStyle = '#00005E';
        this.context.fillRect(x, y, player.health, 10);
    }
    else if(player.health <= 10 && player.health >= 0){
        this.context.fillStyle = '#00003E';
        this.context.fillRect(x, y, player.health, 10);
    }
}
    //HP Text
